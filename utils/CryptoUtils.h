...
public:
    ...
    static std::pair<EVP_PKEY*, EVP_PKEY*> generate_identity_keypair(); // Ed25519

    static std::tuple<EVP_PKEY*, EVP_PKEY*, std::vector<uint8_t>> generate_signed_prekey(EVP_PKEY* identity_key); // X25519 + signature
